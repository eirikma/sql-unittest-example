...
-- file for inserting data that should only be set in preprod
...
insert into persistent_property (key, value) values ('environment', 'TEST');
delete from PERSISTENT_PROPERTY where key = 'core/proxy/war/environment';
insert into persistent_property (key, value) values ('core/proxy/war/environment', 'TEST');